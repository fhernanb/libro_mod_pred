...
description: "Libro de Modelos Predictivos fue ."
---
...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'rpart', 'rpart.plot', 'MPV'), 'packages.bib')
```
...
[Olga Usuga](http://scienti.colciencias.gov.co:8081/cvlac/visualizador/generarCurriculoCv.do?cod_rh=0001417591)  
[Carmen Patiño](http://scienti.colciencias.gov.co:8081/cvlac/visualizador/generarCurriculoCv.do?cod_rh=0001417591)

## Estructura del libro {-}

En el capítulo \@ref(regarb) se presenta el .
