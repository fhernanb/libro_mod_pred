...
$$
\sum_{i=1}^{n}\left( y_{i}-\beta_0 - \sum_{j=1}^p \beta_j x_{ij} \right)^2 
$$
...
**Pregunta:**  
¿Cómo se obtienen las estimaciones de \(Y\) para las tres nuevas observaciones usando el modelo Ridge ajustado?



## Regresión Lasso {-}

La regresión Lasso utiliza una penalización basada en el valor absoluto de los coeficientes.
...
```r
# Nuevas observaciones (las mismas)
nuevos <- matrix(c(
  3.0, 110, 200, 6,
  2.5, 95, 160, 4,
  3.2, 130, 220, 8
...
- La elección depende del contexto… como casi todo en estadística, aunque a algunos les cueste aceptarlo.
