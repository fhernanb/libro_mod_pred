...
Los árboles de regresión son árboles de decisión para asignar un valor de $\hat{y}$ dependiendo de los valores de las covariables. Para conocer más sobre el tema se recomienda ver [este video](https://www.youtube.com/watch?v=7VeUPuFGJHk) y también leer este [documento](https://rafalab.github.io/pages/649/).
...
text(x=90, y=73, labels='y=16', col=4)
text(x=190, y=73, labels='y=20', col=4)
```
...
```{r tree01, fig.align='center', fig.height=6, fig.width=4}
plot(mod2)
text(mod2)
```
