...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'rpart', 'rpart.plot', 'MPV', 'tree', 'adabag', 'gbm', 'MASS', 'disttree', 'RelDists', 'gamlss'), 'packages.bib')
```
...
En los capítulos \@ref(arb-de-regre) y \@ref(arb-de-clasif) se presentann los árboles de regresión y de clasificación. En el capítulo \@ref(arb-distri) se muestra una generalización de los árboles de regresión incluyendo distribuciones de probabilidad para la variable respuesta.
