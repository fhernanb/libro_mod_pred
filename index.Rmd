...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'rpart', 'rpart.plot', 'MPV', 'tree', 'adabag'), 'packages.bib')
```
...
[Carmen Patiño](http://scienti.colciencias.gov.co:8081/cvlac/visualizador/generarCurriculoCv.do?cod_rh=0000756008)
