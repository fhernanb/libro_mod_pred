...
```{block2, type='rmdtip'}
Para conocer más sobre el tema se recomienda ver [este video](https://www.youtube.com/watch?v=7VeUPuFGJHk) y también leer este [documento](https://www.stat.cmu.edu/~cshalizi/350/lectures/22/lecture-22.pdf).
```
