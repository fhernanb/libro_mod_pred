...
X_train <- train_data[, c("lstat", "rm", "dis", "tax", "ptratio")]
X_test  <- test_data[, c("lstat", "rm", "dis", "tax", "ptratio")]
y_train <- train_data["medv"]
y_test  <- test_data["medv"]
...
Entrenamos el modelo con `X_train` y obtenemos las predicciones para `X_test`:
